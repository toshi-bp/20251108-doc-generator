...
このプロジェクトは、チャット内容に基づいて古いドキュメントを新しいものに更新するための Python スクリプトです。OpenAI API を使用して、ドキュメントの内容を生成し、更新されたドキュメントを指定されたフォルダに保存します。
...
2. `src/config.py`に OpenAI API キーやファイルパスを設定します。
